                    ...
                    <aside class="onde-estamos">
                        ...
                        <ul>
                            <li id="whats"><i class="fa-brands fa-whatsapp-square"></i><a
                                href="">(11) 9 8589-0992</a></li>
                            <li id="email"><i class="fa-solid fa-envelope"></i><a href="#">hasandahbur21@gmail.com</a>
                            </li>
                            <li id="insta"><i class="fa-brands fa-instagram-square"></i><a href="#">Hasan Basam</a></li>
                        </ul>
                    </aside>
                </main>
            </div>
